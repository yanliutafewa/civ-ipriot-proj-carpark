...
class CarParkManageCenter:
    ...
    def __init__(self):
        ...
        l_11.grid(row=0, column=0, sticky="W", pady=(20,5), padx=(50, 5))
        l_12.grid(row=1, column=0, sticky="W", pady=5, padx=(50, 5))
        l_13.grid(row=2, column=0, sticky="W", pady=5, padx=(50, 5))
        l_14.grid(row=3, column=0, sticky="W", pady=5, padx=(50, 5))
        l_15.grid(row=4, column=0, sticky="W", pady=5, padx=(50, 5))
        l_16.grid(row=5, column=0, sticky="W", pady=5, padx=(50, 5))
        ...
        l_21.grid(row=0, column=1, sticky="W", pady=(20,5))
        l_22.grid(row=1, column=1, sticky="W", pady=5)
        l_23.grid(row=2, column=1, sticky="W", pady=5)
        l_24.grid(row=3, column=1, sticky="W", pady=5)
        l_25.grid(row=4, column=1, sticky="W", pady=5)
        l_26.grid(row=5, column=1, sticky="W", pady=5)
        ...
        l_31.grid(row=0, column=2, sticky="W", pady=(20,5), padx=(60, 5))
        l_32.grid(row=1, column=2, sticky="W", pady=5, padx=(60, 5))
        l_33.grid(row=2, column=2, sticky="W", pady=5, padx=(60, 5))
        l_34.grid(row=3, column=2, sticky="W", pady=5, padx=(60, 5))
        l_35.grid(row=4, column=2, sticky="W", pady=5, padx=(60, 5))
        l_36.grid(row=5, column=2, sticky="W", pady=5, padx=(60, 5))
        ...
        # this will arrange entry widgets
        l_41.grid(row=0, column=3, sticky="W", pady=(20,5))
        l_42.grid(row=1, column=3, sticky="W", pady=5)
        l_43.grid(row=2, column=3, sticky="W", pady=5)
        l_44.grid(row=3, column=3, sticky="W", pady=5)
        l_45.grid(row=4, column=3, sticky="W", pady=5)
        l_46.grid(row=5, column=3, sticky="W", pady=5)
        ...
        l_51.grid(row=0, column=4, sticky="W", pady=(20,5), padx=(60, 5))
        l_52.grid(row=1, column=4, sticky="W", pady=5, padx=(60, 5))
        l_53.grid(row=2, column=4, sticky="W", pady=5, padx=(60, 5))
        l_54.grid(row=3, column=4, sticky="W", pady=5, padx=(60, 5))
        l_55.grid(row=4, column=4, sticky="W", pady=5, padx=(60, 5))
        l_56.grid(row=5, column=4, sticky="W", pady=5, padx=(60, 5))
        ...
        # this will arrange entry widgets
        l_61.grid(row=0, column=5, sticky="W", pady=(20,5))
        l_62.grid(row=1, column=5, sticky="W", pady=5)
        l_63.grid(row=2, column=5, sticky="W", pady=5)
        l_64.grid(row=3, column=5, sticky="W", pady=5)
        l_65.grid(row=4, column=5, sticky="W", pady=5)
        l_66.grid(row=5, column=5, sticky="W", pady=5)
